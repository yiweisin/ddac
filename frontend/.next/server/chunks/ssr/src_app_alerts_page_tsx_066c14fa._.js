...
function AlertsPage() {
    ...
    const fetchAlerts = async ()=>{
        try {
            setIsLoading(true);
            setError(null);
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getPriceAlerts"])();
            setAlerts(data);
        } catch (err) {
    ...
    const handleDeleteAlert = async (id)=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deletePriceAlert"])(id);
...
//# sourceMappingURL=src_app_alerts_page_tsx_066c14fa._.js.map